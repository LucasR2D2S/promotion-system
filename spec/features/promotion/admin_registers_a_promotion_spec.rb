...
feature 'Admin registers a promotion' do
  ...
  scenario 'and choose product categories' do
    ...
    Category.create!(name: 'Jogos', code: 'GAME')
    Category.create!(name: 'Livros', code: 'BOOK')
    Category.create!(name: 'Monitores', code: 'DISPLAY')
    user = User.create!(email: 'joao@email.com', password: '123456')
    ...
    expect(page).not_to have_content 'Livros'
  end
end